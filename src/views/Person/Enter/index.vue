<template>
  <div class="lodging-application-page" id="lodging-application-page">
    ...
    <div class="lodging-wrapper">
      ...
      <el-tabs v-model="activeTab" tab-position="right" style="height: 90px" class="tabs" @tab-click="handleTabClick">
...
import type { BasicInfo, PracticeInfo, LodgingInfo, PersonSubmitRequest } from '@/types'
...
const breadcrumbItems = computed(() => [
  { label: '人员录入', to: '/person/enter/form' },
  { label: '录入方式', to: methodRoute.value },
...
const _handleSubmit = async () => {
  ...
  try {
    ...
    const payload: PersonSubmitRequest = {
      basic: { ...formData.basic },
      practice: { ...formData.practice },
      // lodging: { ...lodgingData }
    }

    await personInfo(payload)
